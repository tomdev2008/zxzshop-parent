...
(function($) {
	$.fn.himallDistrict = function(options) {
		...
		this.each(function() {
			...
			var himallDistrict = '<div class="himall-district" id="' + thisId + '"><div class="district-hd" style=\"position:relative;\"><span>请选择省</span><span>请选择市</span><label style=\"position:absolute;right:5px;top:5px;\"></label></div>' + provinceStr + '<ul class="district-ul city-ul cl"></ul></div>';
