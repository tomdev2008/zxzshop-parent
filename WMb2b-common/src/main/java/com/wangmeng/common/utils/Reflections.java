...
public class Reflections {
	...
	public static Field getAccessibleField(final Object obj, final String fieldName) {
		...
		Validate.notEmpty(fieldName.trim(), "fieldName can't be blank");
...
//				System.out.println(searchType.getName());
	...
	public static Method getAccessibleMethodSimple(final Object obj, final String methodName,
			final Class<?>... parameterTypes) {
		Validate.notNull(obj, "object can't be null");
		//Validate.notBlank(methodName, "methodName can't be blank");
...
//		Assert.notNull(name, "Method name must not be null");
	 ...
	 * @return the Method object, or {@code null} if none found
	 */
	public static Method findMethodF(Class<?> clazz, String name, Class<?>... paramTypes) {
//		Assert.notNull(clazz, "Class must not be null");
//		Assert.notNull(name, "Method name must not be null");
		Class<?> searchType = clazz;
		while (searchType != null) {
