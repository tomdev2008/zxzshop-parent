...
public class MakeCertPic {
   ...
   public String getCertPic(int width, int height, OutputStream os) {
	   ...
	   /***********************存入缓存*********************************************/
	   ICacheExtService cacheService = (ICacheExtService)ApplicationContextHolderSingleton.getInstance().getBean("cacheExtService");
	   cacheService.setCache(strEnsure, strEnsure,30000);
	   /********************************************************************/
