    ...
    $('.delete').click(function(){
        ...
        $.dialog({
            ...
            ok:function(){
            	...
            	$.ajax({
    				type:"POST",
    				url:'delProductcategoriesList.do',
    				data:"id=" + _id,
    				success:function(data){
    					
    					window.location.href="../ProductCategories/toProductcategoriesList.do"; 
    			    }
            ...
            cancel:function(){},
            content:'<div><div style="text-align:center;font-size:16px;">您确定要删除'+name+'吗？</div><div style="color:#b39a5a;width:280px;margin:20px auto auto auto;line-height:20px">提示：删除后，将影响已使用的该分类的商品，该分类的下级将删除</div></div>'
        })
    })
    $('.add').click(function(){
        $.dialog({
