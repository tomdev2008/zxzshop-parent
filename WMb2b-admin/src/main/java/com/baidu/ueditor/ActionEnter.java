	...
	public String invoke() {
		...
		switch ( actionCode ) {
			...
			case ActionMap.UPLOAD_IMAGE:
				 ...
				 FileEntity entity=fileUploadService.upload(file);
				 state=new BaseState(true,"上传成功");
				 state.putInfo("url", configuration.getString("media_domain")+entity.getFilepath());
				 state.putInfo("type",entity.getAttachmentType());
				 state.putInfo("original",entity.getOfilename());
				 break;
