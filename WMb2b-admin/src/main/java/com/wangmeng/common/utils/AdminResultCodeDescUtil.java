 ...
 * </ul>
 */
public class AdminResultCodeDescUtil {
	...
	private AdminResultCodeDescUtil() {
	}
	
	//单例实例
	private static class SingletonHolder {
		// 中文
		public static AdminResultCodeDescUtil instance = new AdminResultCodeDescUtil();
	}
	 ...
	 * @return
	 */
	public static AdminResultCodeDescUtil getInstanceBy() { 
