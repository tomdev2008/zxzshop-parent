 ...
 * </ul>
 */
public class BrandApplayVo extends AbstractSerializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 1614255370545233391L;
	...
	private String oldBrandName;//用来记录老的品牌名
	...
	public String toString() {
		return "BrandApplayVo [id=" + id + ", enterPrInfoId=" + enterPrInfoId
				...
				+ ", nullFlag=" + nullFlag + ", oldBrandName=" + oldBrandName
